...
import Controller.buscarclientesViewController;
 ...
 * @author rafas
 */
public class buscarclientesView extends javax.swing.JFrame {

    /**
     * CRIAÇAO DO FORMULARIO DE BUSCAR CLIENTES
     */
    private buscarclientesViewController controller; // DECLARAÇÃO DA VARIAVEL

    public buscarclientesView() {
        controller = new buscarclientesViewController(); // INICIALIZAÇAO DA VARIÁVEL
        initComponents();
    ...
    void ocultar_coluna() { // DEIXAR AS COLUNAS OCULTAS, NÃO APARECENDO PARA O USUÁRIO
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        mostrar(txt_pesquisar.getText()); // AO CLICAR NO BOTÃO BUSCAR, ELE MOSTRA TODOS OS REGISTROS CONTIDOS NO BANCO
    ...
    private void TB_listaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TB_listaMousePressed
        if (evt.getClickCount() == 2) { // BLOCO RESPONSÁVEL POR CONTAR O DOUBLE CLICK DO MOUSE COMO ESCOLHA DO FUNCIONÁRIO
            ...
            reservasView.txt_id_cliente.setText(cod);
            reservasView.txt_cliente.setText(nome);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarclientesView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarclientesView().setVisible(true);
            }
        });
    }
